    ...
    if test_size != 0:
        if H_2:
            ...
            if not verbose:
                print(H_2)
                print("+----------+ Testing +----------+")
            test = evaluate_theory_prolog(H_2[0], file, positive_example_ids_test, negative_example_ids_test, verbose)
            #os.remove("theory.txt")
            # rint(test)
        ...
        if positive_example and negative_example:
            if not verbose:
                print(H_2)
                print("+----------+ Learning +----------+")
            test = evaluate_theory_prolog(H_2[0], file, positive_example_ids_training, negative_example_ids_training, verbose)
            #os.remove("theory.txt")
            return MIL(H_2[0], test.accuracy, test.precision, test.sensitivity, test.specificity, test.fscore, end_time)
        else:
            os.remove("theory.txt")

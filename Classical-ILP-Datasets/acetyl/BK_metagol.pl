...
metarule([P, Q, C, R, D],  [P, A, B],  [[Q, B, C], [R, A, D]]).
metarule([P, Q, R, E],  [P, A, B],  [[Q, A, C], [R, B, E, D]]).
metarule([P, Q, C, R, D],  [P, A, B],  [[Q, A, C], [R, B, D]]).
metarule([P, Q, D, R, E],  [P, A, B],  [[Q, A, D], [R, B, E, C]]).
%metarule([P, Q, D, R],  [P, A, B],  [[Q, A, D], [R, B, C]]).
metarule([P, Q, D, R, E],  [P, A, B],  [[Q, B, D], [R, A, E, C]]).
%metarule([P, Q, D, R], 	 [P, A, B],  [[Q, B, D], [R, A, C]]).
metarule([P, Q, R, D],  [P, A, B],  [[Q, B, C], [R, A, D, C]]).
